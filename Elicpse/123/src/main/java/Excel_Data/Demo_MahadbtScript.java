...
public class Demo_MahadbtScript {
...
//Current Course :	
	         ...
	         //     String ApplicationID  = String.valueOf(row.getCell(87).getNumericCellValue());
...
//Sucess Button : 
		   //        driver.findElement(By.xpath("//*[@id=\"mm-0\"]/div[4]/div[2]/button[1]")).click();
		           ...
		           try {
		                ...
		                // If success condition is met, write "Yes" to Excel
		                row.createCell(164).setCellValue("Yes");
		            } catch (TimeoutException e) {

		                row.createCell(164).setCellValue("No");
		            }   
     ...
     //Hosteller Certificate/Warden Certificate	            
     	        	...
     	        	/*    // Delete the downloaded file
     	        	    ...
     	        	    if (downloadedFile.exists()) {
     	        	    	...
     	        	    	System.out.println("Can't Able to Delete the file");
     	        	    }
     	        	    */
     	        	} catch (IOException e) {
     	        	    System.out.println("Not work");
