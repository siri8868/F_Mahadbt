...
public class Update {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            FileInputStream file = new FileInputStream(new File("C:\\Users\\Shravani\\OneDrive\\Pictures\\Auto\\Forstu_Automation\\Forstu.xlsx"));
    ...
    private static WebElement getHobbyCheckbox(WebDriver driver, String hobby) {
        ...
        if (trimmedHobby.equals("cricket")) {
            return driver.findElement(By.className("rq8Mwb"));
